...
NROY_inds8_pre = NROY_inds7[which(impl7^2<qchisq(p = 0.995,df = q))]
...
NROY_inds10_pre = NROY_inds9[which(impl9^2<qchisq(p = 0.995,df = q))]
...
NROY_inds11_pre = NROY_inds10[which(impl10^2<qchisq(p = 0.995,df = q))]
